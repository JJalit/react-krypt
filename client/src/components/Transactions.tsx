...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }: TransactionsCard) => {
...
const Transactions = () => {
  const { transactions, currentAccount } = useContext<State>(TransactionContext);
